...
const EditUser = ({onclose, data, callFunc}) => {
  ...
  return (
    <div className="fixed top-0 right-0 left-0 bottom-0 w-full h-full z-[11] flex justify-center items-center bg-slate-200 bg-opacity-70">
      <div className="w-full bg-white shadow-md p-4 max-w-sm">
        ...
        <h1 className="pb-4 text-lg font-medium">Quyền truy cập</h1>
        <p>Tên: {data.name}</p>
        ...
        <div className="flex items-center justify-between my-3">
          ...
          <select className="border px-4 py-1" value={userRole} onChange={handleOnChangeSelect}>
            ...
            <button className="w-fit mx-auto block py-1 px-4 rounded-full bg-red-600 hover:bg-red-700 text-white" 
